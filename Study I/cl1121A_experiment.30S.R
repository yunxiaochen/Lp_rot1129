...
#source('counter1121.R')
#source('cl1121A_experiment.15S.R')
...
out = foreach(i = 1:sim, .packages = c("lavaan","gtools","zoo","GPArotation","numDeriv"), .errorhandling = "pass") %dopar%{
  ...
  if(T){
    ...
    #bic-accuracy
    bic=sapply(c_bic_list,sgnrefit_optim2B2,L_irls=L_est,S=S,N=N,mod=0,k=-1,Psi0=ans_est2$Psi,B=diag(rep(1,n_col))) #,B=T_est
    res$lasso.ap0.01$c= c0 = c_bic_list[which.min(bic)[1]]
    res$lasso.ap0.01$L_bic=L_bic=sgnrefit_optim2B2(c0,L_est,S,N,mod=1,Psi0=ans_est2$Psi,B=diag(rep(1,n_col)))$L
    ...
    #bic-accuracy
    bic=sapply(c_bic_list,sgnrefit_optim2B2,L_irls=L_est,S=S,N=N,mod=0,k=-1,Psi0=ans_est3$Psi,B=diag(rep(1,n_col)))
    res$lasso.ap0.05$c= c0 = c_bic_list[which.min(bic)[1]]
    res$lasso.ap0.05$L_bic=L_bic=sgnrefit_optim2B2(c0,L_est,S,N,mod=1,Psi0=ans_est3$Psi,B=diag(rep(1,n_col)))$L
    ...
    #bic-accuracy
    bic=sapply(c_bic_list,sgnrefit_optim2B2,L_irls=L_est,S=S,N=N,mod=0,k=-1,Psi0=ans_est4$Psi,B=diag(rep(1,n_col)))
    res$lasso.ap0.1$c= c0 = c_bic_list[which.min(bic)[1]]
    res$lasso.ap0.1$L_bic=L_bic=sgnrefit_optim2B2(c0,L_est,S,N,mod=1,Psi0=ans_est4$Psi,B=diag(rep(1,n_col)))$L
    ...
    #bic-accuracy
    bic=sapply(c_bic_list,sgnrefit_optim2B2,L_irls=L_est,S=S,N=N,mod=0,k=-1,Psi0=ans_est5$Psi,B=diag(rep(1,n_col)))
    res$lasso.ap0.2$c= c0 = c_bic_list[which.min(bic)[1]]
    res$lasso.ap0.2$L_bic=L_bic=sgnrefit_optim2B2(c0,L_est,S,N,mod=1,Psi0=ans_est5$Psi,B=diag(rep(1,n_col)))$L
    ...
    #bic-accuracy
    bic=sapply(c_bic_list,sgnrefit_optim2B2,L_irls=L_est,S=S,N=N,mod=0,k=-1,Psi0=ans_est6$Psi,B=diag(rep(1,n_col)))
    res$lasso.ap0.5$c= c0 = c_bic_list[which.min(bic)[1]]
    res$lasso.ap0.5$L_bic=L_bic=sgnrefit_optim2B2(c0,L_est,S,N,mod=1,Psi0=ans_est6$Psi,B=diag(rep(1,n_col)))$L
